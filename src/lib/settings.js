...
(function () {
  const DEFAULT_SETTINGS = {
    ...
    // Симулированные зрители (базовая «жизнь» в чате) — работают в любом режиме.
    simulatedViewers: true,
    // В live-режиме просить DeepSeek самому придумывать реплики зрителей.
    aiViewers: true,
